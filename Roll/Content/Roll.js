...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Operators,mdw,Dice,Resolver,Number,Util,Seq,Random,Parser,PrintfHelpers,Collections,FSharpSet,Strings,parseInt,jQuery,UI,Next,Client,Doc,Roll,Client1,Var,List,AttrProxy,RollRecord,T,Key,ListModel,String;
 Runtime.Define(Global,{
  Util:{
   nomatch:function()
   {
  ...
  mdw:{
    ...
    Resolver:Runtime.Class({
     ...
     Resolve1:function(cmd)
     {
      ...
      if(cmd.$==1)
       {
        rest=cmd.$1;
        return this.Resolve(cmd.$0)+this.Resolve1(rest);
       }
      else
       {
        return this.Resolve(cmd.$0);
       }
     }
    },{
     New:function(random)
   ...
   Parser:{
    Parse:function(txt)
    {
     ...
     matchValue=[txt,0];
     activePatternResult=Parser["|CompoundExpression|_|"](matchValue[0],matchValue[1]);
     if(activePatternResult.$==1)
      {
       tupledArg=activePatternResult.$0[1];
       return Parser["|Next|Empty|"](tupledArg[0],tupledArg[1]).$==1?activePatternResult.$0[0]:Operators.FailWith("failed to parse '"+PrintfHelpers.toSafe(txt)+"'");
      }
     else
      {
    ...
    {
     return Parser.alpha().add(Parser.numeric());
    }),
    ...
    "|Chars|_|":function(_,_1,_2)
    {
     ...
     _arg1=[_1,_2];
     activePatternResult=Parser["|Char|_|"](_,_arg1[0],_arg1[1]);
     if(activePatternResult.$==1)
      {
       tupledArg=activePatternResult.$0;
       return{
        $:1,
        $0:Parser["|MaybeChars|"](_,tupledArg[0],tupledArg[1])
       };
      }
     else
      {
    ...
    "|Char|_|":function(_,_1,_2)
    {
     var _arg1;
     _arg1=[_1,_2];
     return Parser["|Next|Empty|"](_arg1[0],_arg1[1]).$==1?{
      $:0
    ...
    {
     var _arg1,activePatternResult,next;
     _arg1=[_,_1];
     activePatternResult=Parser["|SimpleExpression|_|"](_arg1[0],_arg1[1]);
     if(activePatternResult.$==1)
      {
    ...
    "|MaybeChars|":function(_,_1,_2)
    {
     ...
     if(activePatternResult.$==1)
      {
       tupledArg=activePatternResult.$0;
       return Parser["|MaybeChars|"](_,tupledArg[0],tupledArg[1]);
      }
     else
      {
       return _arg1;
    ...
    {
     var _arg3,_arg10_,_arg11_,activePatternResult,i1;
     _arg3=[_,_1];
     _arg10_=_arg3[0];
     _arg11_=_arg3[1];
     activePatternResult=Parser["|Chars|_|"](Parser.numeric(),_arg10_,_arg11_);
     if(activePatternResult.$==1)
      {
       i1=activePatternResult.$0;
       return{
        $:1,
        $0:[parseInt(Parser.sub(_arg3[0],_arg3[1],i1[0],i1[1])),i1]
       };
      }
     else
      {
    ...
    "|SimpleExpression|_|":function(_,_1)
    {
     ...
     if(activePatternResult.$==0)
       ...
       if(activePatternResult.$0[0]===100)
        {
         ...
         if(activePatternResult1.$==1)
          ...
          {
           activePatternResult2=Parser["|Number|_|"](_arg2[0],_arg2[1]);
           if(activePatternResult2.$==1)
            {
             tupledArg1=activePatternResult2.$0[1];
             activePatternResult3=Parser["|Next|Empty|"](tupledArg1[0],tupledArg1[1]);
             if(activePatternResult3.$==0)
              {
               if(activePatternResult3.$0[0]===100)
                {
                 tupledArg2=activePatternResult3.$0[1];
                 activePatternResult4=Parser["|Number|_|"](tupledArg2[0],tupledArg2[1]);
                 if(activePatternResult4.$==1)
                  ...
                  {
                   activePatternResult5=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                   if(activePatternResult5.$==1)
                    {
                     tupledArg3=activePatternResult5.$0[1];
                     activePatternResult6=Parser["|Next|Empty|"](tupledArg3[0],tupledArg3[1]);
                     if(activePatternResult6.$==0)
                      {
                       if(activePatternResult6.$0[0]===100)
                        ...
                        {
                         activePatternResult7=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                      ...
                      {
                       activePatternResult8=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                    ...
                    {
                     activePatternResult9=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResulta=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                 if(activePatternResulta.$==1)
                  {
                   tupledArg4=activePatternResulta.$0[1];
                   activePatternResultb=Parser["|Next|Empty|"](tupledArg4[0],tupledArg4[1]);
                   if(activePatternResultb.$==0)
                    {
                     if(activePatternResultb.$0[0]===100)
                      ...
                      {
                       activePatternResultc=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                    ...
                    {
                     activePatternResultd=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                  ...
                  {
                   activePatternResulte=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResultf=Parser["|Number|_|"](_arg2[0],_arg2[1]);
               if(activePatternResultf.$==1)
                {
                 tupledArg5=activePatternResultf.$0[1];
                 activePatternResult10=Parser["|Next|Empty|"](tupledArg5[0],tupledArg5[1]);
                 if(activePatternResult10.$==0)
                  {
                   if(activePatternResult10.$0[0]===100)
                    ...
                    {
                     activePatternResult11=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                  ...
                  {
                   activePatternResult12=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResult13=Parser["|Number|_|"](_arg2[0],_arg2[1]);
            ...
            {
             activePatternResult14=Parser["|Number|_|"](_arg2[0],_arg2[1]);
             if(activePatternResult14.$==1)
              {
               tupledArg6=activePatternResult14.$0[1];
               activePatternResult15=Parser["|Next|Empty|"](tupledArg6[0],tupledArg6[1]);
               if(activePatternResult15.$==0)
                {
                 if(activePatternResult15.$0[0]===100)
                  ...
                  {
                   activePatternResult16=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResult17=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResult18=Parser["|Number|_|"](_arg2[0],_arg2[1]);
        ...
        {
         activePatternResult19=Parser["|Number|_|"](_arg2[0],_arg2[1]);
         if(activePatternResult19.$==1)
          {
           tupledArg7=activePatternResult19.$0[1];
           activePatternResult1a=Parser["|Next|Empty|"](tupledArg7[0],tupledArg7[1]);
           if(activePatternResult1a.$==0)
            {
             if(activePatternResult1a.$0[0]===100)
              {
               tupledArg8=activePatternResult1a.$0[1];
               activePatternResult1b=Parser["|Number|_|"](tupledArg8[0],tupledArg8[1]);
               if(activePatternResult1b.$==1)
                ...
                {
                 activePatternResult1c=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                 if(activePatternResult1c.$==1)
                  {
                   tupledArg9=activePatternResult1c.$0[1];
                   activePatternResult1d=Parser["|Next|Empty|"](tupledArg9[0],tupledArg9[1]);
                   if(activePatternResult1d.$==0)
                    {
                     if(activePatternResult1d.$0[0]===100)
                      ...
                      {
                       activePatternResult1e=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                    ...
                    {
                     activePatternResult1f=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                  ...
                  {
                   activePatternResult20=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResult21=Parser["|Number|_|"](_arg2[0],_arg2[1]);
               if(activePatternResult21.$==1)
                {
                 tupledArga=activePatternResult21.$0[1];
                 activePatternResult22=Parser["|Next|Empty|"](tupledArga[0],tupledArga[1]);
                 if(activePatternResult22.$==0)
                  {
                   if(activePatternResult22.$0[0]===100)
                    ...
                    {
                     activePatternResult23=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                  ...
                  {
                   activePatternResult24=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResult25=Parser["|Number|_|"](_arg2[0],_arg2[1]);
            ...
            {
             activePatternResult26=Parser["|Number|_|"](_arg2[0],_arg2[1]);
             if(activePatternResult26.$==1)
              {
               tupledArgb=activePatternResult26.$0[1];
               activePatternResult27=Parser["|Next|Empty|"](tupledArgb[0],tupledArgb[1]);
               if(activePatternResult27.$==0)
                {
                 if(activePatternResult27.$0[0]===100)
                  ...
                  {
                   activePatternResult28=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResult29=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResult2a=Parser["|Number|_|"](_arg2[0],_arg2[1]);
          ...
          {
           activePatternResult2b=Parser["|Number|_|"](_arg2[0],_arg2[1]);
           if(activePatternResult2b.$==1)
            {
             tupledArgc=activePatternResult2b.$0[1];
             activePatternResult2c=Parser["|Next|Empty|"](tupledArgc[0],tupledArgc[1]);
             if(activePatternResult2c.$==0)
              {
               if(activePatternResult2c.$0[0]===100)
                ...
                {
                 activePatternResult2d=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResult2e=Parser["|Number|_|"](_arg2[0],_arg2[1]);
            ...
            {
             activePatternResult2f=Parser["|Number|_|"](_arg2[0],_arg2[1]);
      ...
      {
       activePatternResult30=Parser["|Number|_|"](_arg2[0],_arg2[1]);
       if(activePatternResult30.$==1)
        {
         tupledArgd=activePatternResult30.$0[1];
         activePatternResult31=Parser["|Next|Empty|"](tupledArgd[0],tupledArgd[1]);
         if(activePatternResult31.$==0)
          {
           if(activePatternResult31.$0[0]===100)
            {
             tupledArge=activePatternResult31.$0[1];
             activePatternResult32=Parser["|Number|_|"](tupledArge[0],tupledArge[1]);
             if(activePatternResult32.$==1)
              ...
              {
               activePatternResult33=Parser["|Number|_|"](_arg2[0],_arg2[1]);
               if(activePatternResult33.$==1)
                {
                 tupledArgf=activePatternResult33.$0[1];
                 activePatternResult34=Parser["|Next|Empty|"](tupledArgf[0],tupledArgf[1]);
                 if(activePatternResult34.$==0)
                  {
                   if(activePatternResult34.$0[0]===100)
                    ...
                    {
                     activePatternResult35=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                  ...
                  {
                   activePatternResult36=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResult37=Parser["|Number|_|"](_arg2[0],_arg2[1]);
            ...
            {
             activePatternResult38=Parser["|Number|_|"](_arg2[0],_arg2[1]);
             if(activePatternResult38.$==1)
              {
               tupledArg10=activePatternResult38.$0[1];
               activePatternResult39=Parser["|Next|Empty|"](tupledArg10[0],tupledArg10[1]);
               if(activePatternResult39.$==0)
                {
                 if(activePatternResult39.$0[0]===100)
                  ...
                  {
                   activePatternResult3a=Parser["|Number|_|"](_arg2[0],_arg2[1]);
                ...
                {
                 activePatternResult3b=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResult3c=Parser["|Number|_|"](_arg2[0],_arg2[1]);
          ...
          {
           activePatternResult3d=Parser["|Number|_|"](_arg2[0],_arg2[1]);
           if(activePatternResult3d.$==1)
            {
             tupledArg11=activePatternResult3d.$0[1];
             activePatternResult3e=Parser["|Next|Empty|"](tupledArg11[0],tupledArg11[1]);
             if(activePatternResult3e.$==0)
              {
               if(activePatternResult3e.$0[0]===100)
                ...
                {
                 activePatternResult3f=Parser["|Number|_|"](_arg2[0],_arg2[1]);
              ...
              {
               activePatternResult40=Parser["|Number|_|"](_arg2[0],_arg2[1]);
            ...
            {
             activePatternResult41=Parser["|Number|_|"](_arg2[0],_arg2[1]);
        ...
        {
         activePatternResult42=Parser["|Number|_|"](_arg2[0],_arg2[1]);
         if(activePatternResult42.$==1)
          {
           tupledArg12=activePatternResult42.$0[1];
           activePatternResult43=Parser["|Next|Empty|"](tupledArg12[0],tupledArg12[1]);
           if(activePatternResult43.$==0)
            {
             if(activePatternResult43.$0[0]===100)
              ...
              {
               activePatternResult44=Parser["|Number|_|"](_arg2[0],_arg2[1]);
            ...
            {
             activePatternResult45=Parser["|Number|_|"](_arg2[0],_arg2[1]);
          ...
          {
           activePatternResult46=Parser["|Number|_|"](_arg2[0],_arg2[1]);
    ...
    Client:{
     ...
     RollForm:Runtime.Field(function()
     {
      ...
      arg203=function()
      {
       ...
       arg00=Parser.Parse(spec);
       todo=RollRecord.Create(spec,Dice.Instance().Resolve1(arg00));
       return Client1.Rolls().Set(Seq.append(List.ofArray([todo]),Var.Get(Client1.Rolls().Var)));
      };
     ...
     renderItem:function(m)
     {
      ...
      arg202=List.ofArray([Doc.TextNode(String(m.Value))]);
